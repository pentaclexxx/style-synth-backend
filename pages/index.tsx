...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[url('/bg-middle.png')] bg-cover bg-no-repeat bg-center text-gray-900">

      {/* HEADER SECTION */}
      <section className="relative text-white text-center pt-32 pb-24">
        <img
          src="/bg-top.png"
          alt="Torn black paper background"
          className="absolute top-[0px] left-0 w-full h-auto pointer-events-none z-0"
        />
        <div className="relative z-10 px-4">
          <h1
            className="text-[150px] sm:text-[180px] lg:text-[200px] font-normal leading-tight"
            style={{ fontFamily: "'Instrument Serif', serif" }}
          >
            <span className="mr-[10rem]">Style</span>Synth
          </h1>
          <p
            className="mt-8 text-[20px] sm:text-[28px] lg:text-[32px] italic ml-[-60px]"
            style={{ fontFamily: "'Instrument Serif', serif" }}
          >
            Style is generated.
            <br />
      ...
      {/* ABOUT SECTION */}
      <section className="relative w-full text-black px-6 py-20 mt-24" style={{ fontFamily: "'Source Serif Pro', serif" }}>
        <div className="max-w-6xl mx-auto">
          <h2 className="text-[36px] font-bold mb-6">About this project</h2>
          ...
          <p className="italic font-bold mb-4 max-w-3xl">
        ...
        <div className="relative z-10 -mt-10">
          <div className="relative mb-12 inline-block">
            <img
              ...
              className="w-[300px] sm:w-[360px] lg:w-[400px] h-auto mx-auto"
            />
            <h2 className="absolute inset-0 flex items-center justify-center text-2xl sm:text-4xl lg:text-5xl font-semibold tracking-[0.055em]"
                style={{ fontFamily: "'Instrument Serif', serif" }}>
              How it works
            </h2>
          </div>

          <div className="grid gap-2 md:grid-cols-3 max-w-5xl mx-auto text-sm sm:text-base">
            <div className="-mt-16">
              <img
                src="/icon-select.png"
                alt="Prompt selection icon"
                className="w-[90px] h-[90px] sm:w-[120px] sm:h-[120px] mx-auto mb-3"
              />
