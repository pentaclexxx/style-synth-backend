    ...
    >
      ...
      >
        <div className="relative z-8 pt-6 sm:pt-8 mt-[-36px] flex flex-col items-center text-center">
          ...
          >
            <span className="mr-[25px] sm:mr-[64px] lg:mr-[100px]">Style</span>Synth
          </h1>
          <p
      ...
      >
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-3 mt-4">
            ...
            {showPrivacy && (
              <div className="text-xs sm:text-sm md:text-base text-gray-700 max-w-sm sm:max-w-md md:max-w-lg transition-opacity duration-200">
                <h3 className="font-semibold mb-1 sm:mb-2">Your information stays private</h3>
                <p className="text-gray-500 mb-1 sm:mb-2">
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <footer className="text-center text-xs sm:text-sm md:text-base text-gray-600 
                             mt-6 sm:mt-8 md:mt-10 pb-4 sm:pb-5 md:pb-6 px-2 sm:px-4 leading-snug sm:leading-normal" 
