  ...
  return (
    <main className="min-h-screen bg-[url('/bg-home.jpg')] bg-cover bg-top text-gray-900 px-4 sm:px-6 py-12">
      ...
      <header className="text-center mb-24">
        <h1 className="text-5xl sm:text-6xl font-serif tracking-wide leading-tight">
          Style Synth
        </h1>
        <p className="italic mt-3 text-lg sm:text-xl">
      ...
      <section className="text-center mb-24">
        ...
        <div className="grid gap-12 md:grid-cols-3 max-w-5xl mx-auto text-sm sm:text-base">
          <div>
            <img
              src="/icon-select.png"
              alt="Hand pressing icon for prompt selection"
          ...
          <div>
            <img
              ...
              alt="Magic wand icon for generating fashion design"
              className="w-[75px] h-[75px] mx-auto mb-3"
            />
          ...
          <div>
            <img
              ...
              alt="Lightbulb icon for reflection"
              className="w-[75px] h-[75px] mx-auto mb-3"
            />
            <p>
