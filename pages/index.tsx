...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[url('/bg-middle.png')] bg-cover bg-no-repeat bg-center text-gray-900 overflow-x-hidden">
      ...
      {/* HEADER SECTION */}
      <section className="relative text-white text-center pt-24 sm:pt-32 pb-20 sm:pb-24">
        <img
          src="/bg-top.png"
          alt="Torn black paper background"
          className="absolute top-[-10px] sm:top-[-20px] left-0 w-full h-auto pointer-events-none z-0"
        />
        <div className="relative z-10 px-4">
          <h1
            className="text-[60px] sm:text-[100px] lg:text-[140px] xl:text-[180px] font-normal leading-tight"
            style={{ fontFamily: "'Instrument Serif', serif" }}
          >
            <span className="mr-4 sm:mr-12 lg:mr-28">Style</span>Synth
          </h1>
          <p
            className="mt-4 sm:mt-6 text-[16px] sm:text-[22px] lg:text-[28px] italic"
            style={{ fontFamily: "'Instrument Serif', serif" }}
          >
            Style is generated.
            <br />
      ...
      {/* ABOUT SECTION */}
      <section className="relative w-full text-black px-4 sm:px-6 lg:px-8 py-16 sm:py-20 mt-12 sm:mt-24" style={{ fontFamily: "'Source Serif Pro', serif" }}>
        ...
        <div className="relative z-10 -mt-10">
          <div className="relative mb-12 inline-block">
            <img
              ...
              className="w-[200px] sm:w-[280px] lg:w-[340px] h-auto mx-auto"
            />
            <h2 className="absolute inset-0 flex items-center justify-center text-xl sm:text-2xl lg:text-3xl font-semibold tracking-[0.055em]" style={{ fontFamily: "'Instrument Serif', serif" }}>
              How it works
            </h2>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-3 max-w-5xl mx-auto text-sm sm:text-base">
            <div className="-mt-10">
              <img
                ...
                className="w-[70px] h-[70px] sm:w-[100px] sm:h-[100px] mx-auto mb-3"
              />
