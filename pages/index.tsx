...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="relative z-8 pt-6 sm:pt-8 mt-[-36px]">
          <h1
            className="mt-[-20px] text-[96px] sm:text-[160px] lg:text-[220px] font-normal leading-tight"
            style={{ fontFamily: "'Instrument Serif', serif" }}
          >
            <span className="mr-[30px] sm:mr-[64px] lg:mr-[100px]">Style</span>Synth
          </h1>
          <p
      ...
      {/* HOW IT WORKS */}
      <section
        className="relative text-center px-4 sm:px-6 lg:px-8 py-10 overflow-hidden"
        style={{ fontFamily: "'Instrument Serif', serif" }}
      >
        {/* Background Image */}
        <img
        ...
        <div className="relative z-10">
          ...
          {/* Input field */}
           <input
            ...
            className="w-60 sm:w-72 md:w-80 text-sm sm:text-base md:text-lg text-center text-gray-500 border border-black rounded-full px-4 py-2 shadow-sm placeholder-gray-400 placeholder:text-sm sm:placeholder:text-base md:placeholder:text-lg outline-none focus:ring-2 focus:ring-black"
