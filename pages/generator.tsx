    ...
    <main className="min-h-screen px-4 py-10 text-gray-900">
      ...
      <div className="flex flex-row justify-start gap-2 max-w-5xl mx-auto mt-8 -mb-px transition-all duration-300">
        <button
          ...
          className={`text-sm sm:text-base md:text-lg px-3 sm:px-4 md:px-6 py-1.5 sm:py-2 border rounded-t-md transition-colors duration-300 ${
            mode === 'guided'
      ...
      <div className="text-center mt-10">
        ...
        <button
          ...
          className="inline-block bg-black text-white px-6 py-2 rounded-full hover:bg-gray-900 transition"
        >
